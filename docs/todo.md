...
- [ ] Update testing for other guesser versions to compare performance on simplified version of the game.
- [ ] Upgrade GuesserV1 and V3 to async architecture.
- [ ] Create an async version of the test runner and add a test that will test V1 and V3 in parallel.
